    ...
    <section id="flota" className="bg-white py-20 sm:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-2xl mx-auto text-center mb-10">
          <Reveal as="p" delay={0} className="text-sm uppercase tracking-widest text-[#8A9BA8] mb-3">
            Nuestra flota
          </Reveal>
        ...
        <Reveal delay={240} className="max-w-xl mx-auto mb-12">
          ...
          />
          <div className="flex justify-between text-xs text-[#8A9BA8] mt-2 px-0.5">
            <span>1</span>
            <span>15</span>
            <span>33</span>
            <span>45</span>
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center max-w-5xl mx-auto">
          ...
          <Reveal delay={120}>
            <div key={vehicle.id} className="animate-fade-in-up" style={{ opacity: 0 }}>
              <p className="text-sm uppercase tracking-widest text-[#8A9BA8] mb-2">Le recomendamos</p>
              ...
              <div className="flex flex-wrap gap-2 mb-5">
                {vehicle.specs.map((s) => (
                  ...
                  >
                    <s.Icon className="w-4 h-4 text-[#8A9BA8]" />
                    {s.label}
                  </span>
                ))}
              </div>
